  ...
  return (
    <div className="container mx-auto py-8">
      <div className="mb-8 text-center">
        <h1 className="mb-4 text-3xl font-bold tracking-tight text-balance sm:text-4xl">Learn French Vocabulary</h1>
        <p className="text-lg text-muted-foreground text-pretty">
          Master French words through interactive lessons and quizzes
        </p>
      </div>
